...
.. |build| image:: https://travis-ci.org/divio/aldryn-django.svg?branch=support/1.11.x
    :target: https://travis-ci.org/divio/aldryn-django
.. |coverage| image:: https://codecov.io/gh/divio/aldryn-django/branch/support/1.11.x/graph/badge.svg
    :target: https://codecov.io/gh/divio/aldryn-django

.. |python| image:: https://img.shields.io/badge/python-2.7%20%7C%203.4%20%7C%203.5%20%7C%203.6%20%7C%C2%A03.7-blue.svg
    :target: https://pypi.org/project/aldryn-django/
.. |django| image:: https://img.shields.io/badge/django-1.11-blue.svg
